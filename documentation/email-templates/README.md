...
- **If you pasted an earlier version of these templates, re-paste both** — the link format changed in Build 77, and **Build 84 added the heart-flame logo image** (hosted at `https://www.myhearthapp.ca/email-logo.png`, a PNG because email clients strip SVG; `alt=""` since the "Hearth" wordmark text follows it).
